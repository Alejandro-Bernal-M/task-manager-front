          ...
          <div className={styles.groupHolder}>
            ...
            <div className={styles.subGroupHolder}>
              {userGroups.map((group, index) => (
                <Subgroup key={index} title={group.subgroup.title} description={group.subgroup.description} groupId={'0'} id={0} subGroupColumn={false} assignationId={group.assignation_id} />
                ))}
            </div>
          </div>
        </div>
